...
git clone -b k3s https://github.com/WOOWTECH/Woow_ollama_docker_compose_all.git Woow_ollama_docker_compose_all-k3s
cd Woow_ollama_docker_compose_all-k3s
...
> For full K3s deployment documentation, switch to the [`k3s` branch](https://github.com/WOOWTECH/Woow_ollama_docker_compose_all/tree/k3s).
