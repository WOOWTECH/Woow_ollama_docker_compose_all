...
> |----------|----------------|-----------------|
> | Docker / Podman Compose | [**Woow_podman_ollama**](https://github.com/WOOWTECH/Woow_podman_ollama) | `main` |
> | K3s / Kubernetes (now a **Helm chart**) | [**Woow_k3s_ollama**](https://github.com/WOOWTECH/Woow_k3s_ollama) | `k3s` |
>
